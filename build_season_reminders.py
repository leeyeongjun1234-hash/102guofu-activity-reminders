...
<head>
  ...
  <style>
    ...
    * {{ box-sizing:border-box; }}
    ...
    .page-nav {{ position:fixed; top:24px; right:max(24px, calc((100vw - 1200px) / 2 + 24px)); z-index:50; display:flex; gap:4px; padding:4px; border:1px solid var(--line); border-radius:8px; background:#f8fafc; white-space:nowrap; }}
    ...
    @media (max-width:760px) {{
      .app {{ padding:76px 16px 16px; }}
      .page-header {{ flex-direction:column; gap:10px; }}
      .page-nav {{ top:12px; right:12px; max-width:calc(100vw - 24px); overflow-x:auto; }}
